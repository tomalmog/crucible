...
Crucible is an open-source, end-to-end ML training platform that takes researchers from raw data to trained model in a single tool — with 13 training algorithms, experiment tracking, evaluation benchmarks, remote cluster support, and a desktop GUI.
