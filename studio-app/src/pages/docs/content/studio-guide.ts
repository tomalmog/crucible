...
The training page is where you configure and launch training runs. Start by picking a training method from the method picker — each method card shows a brief description and recommended use case. After selecting a method, a configuration wizard walks you through the required settings: base model, dataset, hyperparameters, and output path. Once you launch, a live dashboard shows real-time loss charts, learning rate schedules, throughput metrics, and estimated time remaining.
