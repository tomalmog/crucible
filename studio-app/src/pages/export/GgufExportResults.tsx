import type { GgufExportResult } from "../../types/export";

interface GgufExportResultsProps {
  result: GgufExportResult;
}

export function GgufExportResults({ result }: GgufExportResultsProps) {
  return (
    <>
      <div className="stats-grid">
        ...
        <div className="metric-card">
          <span className="metric-label">Quantization</span>
          <span className="metric-value">{result.quant_type}</span>
        </div>
        <div className="metric-card">
