...
export function OnnxExportForm() {
  ...
  function onModelChange(path: string) {
    setModelPath(path);
    setOutputDir(defaultExportDir(path, "onnx"));
  }
    ...
    <div className="page-body">
      ...
      >
        <div className="grid-2">
          ...
          <FormField label="Opset Version">
            <input
              type="number"
              min={7}
              max={21}
              value={opsetVersion}
              onChange={(e) => setOpsetVersion(e.currentTarget.value)}
            />
          </FormField>
        </div>
