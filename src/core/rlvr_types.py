"""RLVR (RL with Verifiable Rewards) typed models."""
...
from core.constants import (
    ...
    DEFAULT_TRAIN_EPOCHS, DEFAULT_TRAIN_HIDDEN_DIM, DEFAULT_TRAIN_LEARNING_RATE,
...
VerifierType = Literal["code", "math"]
...
class RlvrOptions:
    ...
    Attributes:
        ...
        rlvr_data_path: Path to JSONL with verifiable tasks.
        verifier_type: Type of verifier (code or math).
    """
