"""GRPO training typed models.

This module defines immutable data models for Group Relative Policy
Optimization configuration including group sampling and reward scoring.
"""
...
DEFAULT_GRPO_KL_COEFF = 0.1
DEFAULT_GRPO_CLIP_RANGE = 0.2
DEFAULT_GRPO_TEMPERATURE = 1.0


@dataclass(frozen=True)
class GrpoOptions:
    """GRPO training configuration used by CLI, SDK, and run-spec workflows.

    Attributes:
        dataset_name: Logical dataset identifier.
        output_dir: Training artifact output directory.
        grpo_data_path: Path to JSONL file with prompts for group sampling.
    """
