"""DPO training typed models.

This module defines immutable data models for Direct Preference Optimization
training configuration including preference pairs and loss parameters.
"""
...
class DpoExample:
    ...
    Attributes:
        ...
        chosen: Preferred model response text.
        rejected: Non-preferred model response text.
    """
...
@dataclass(frozen=True)
class DpoOptions:
    """DPO training configuration used by CLI, SDK, and run-spec workflows.

    Attributes:
        dataset_name: Logical dataset identifier.
        output_dir: Training artifact output directory.
        dpo_data_path: Path to JSONL file with preference pairs.
    """
