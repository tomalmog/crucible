...
def run_multimodal_training(
    ...
    try:
        ...
        result = _persist_mm_outputs(context, loop_result, run_record.run_id, dataset_version_id, config_hash, random_seed)
...
def _build_mm_context(records, options, training_options, random_seed, run_id, dataset_version_id, config_hash, run_registry):
...
def _persist_mm_outputs(context, loop_result, run_id, dataset_version_id, config_hash, random_seed):
